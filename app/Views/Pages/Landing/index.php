            ...
            <nav class="navigation navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index-2.html"><img src="<?= base_url() ?>/images/logo.png" alt></a>
                    </div>
                    ...
                    <div class="col col-md-6">
                        <div class="right-col">
                            <div class="img-holder">
                                <img src="<?= base_url() ?>/images/about.png" alt>
                            </div>
                ...
                <div class="row">
                    <div class="col col-md-4">
                        <div class="testimonial-left-img-holder">
                            <img src="<?= base_url() ?>/images/testimonials/man.png" alt>
                        </div>
                    </div>
                        ...
                        <div class="testimonial-grids testimonial-slider clearfix">
                            <div class="grid">
                                ...
                                <div class="client-info">
                                    <div class="img-holder">
                                        <img src="<?= base_url() ?>/images/testimonials/img-1.jpg" alt>
                                    </div>
                                    <div class="details">
                                        <h5>Michel jhon</h5>
                            ...
                            <div class="grid">
                                ...
                                <div class="client-info">
                                    <div class="img-holder">
                                        <img src="<?= base_url() ?>/images/testimonials/img-2.jpg" alt>
                                    </div>
                                    <div class="details">
                                        <h5>Alaska</h5>
                            ...
                            <div class="grid">
                                ...
                                <div class="client-info">
                                    <div class="img-holder">
                                        <img src="<?= base_url() ?>/images/testimonials/img-3.jpg" alt>
                                    </div>
                                    <div class="details">
                                        <h5>Shain on</h5>
                                        <p>Manager of Automation</p>
                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="partner-grids partners-slider">
                            <div class="grid">
                                <img src="<?= base_url() ?>/images/partners/img-1.jpg" alt>
                            </div>
                            <div class="grid">
                                <img src="<?= base_url() ?>/images/partners/img-2.jpg" alt>
                            </div>
                            <div class="grid">
                                <img src="<?= base_url() ?>/images/partners/img-3.jpg" alt>
                            </div>
                            <div class="grid">
                                <img src="<?= base_url() ?>/images/partners/img-4.jpg" alt>
                            </div>
                            <div class="grid">
                                <img src="<?= base_url() ?>/images/partners/img-5.jpg" alt>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="team-grids">
                            <div class="grid">
                                <div class="img-social">
                                    <div class="img-holder">
                                        <img src="<?= base_url() ?>/images/team/img-1.jpg" alt>
                                    </div>
                                    <div class="social">
                                        <ul>
                            ...
                            <div class="grid">
                                <div class="img-social">
                                    <div class="img-holder">
                                        <img src="<?= base_url() ?>/images/team/img-2.jpg" alt>
                                    </div>
                                    <div class="social">
                                        <ul>
                                            <li><a href="#"><i class="ti-facebook"></i></a></li>
                            ...
                            <div class="grid">
                                <div class="img-social">
                                    <div class="img-holder">
                                        <img src="<?= base_url() ?>/images/team/img-3.jpg" alt>
                                    </div>
                                    <div class="social">
                                        <ul>
                                            <li><a href="#"><i class="ti-facebook"></i></a></li>
                            ...
                            <div class="grid">
                                <div class="img-social">
                                    <div class="img-holder">
                                        <img src="<?= base_url() ?>/images/team/img-4.jpg" alt>
                                    </div>
                                    <div class="social">
                                        <ul>
                                            <li><a href="#"><i class="ti-facebook"></i></a></li>
                        ...
                        <div class="blog-grids">
                            <div class="grid">
                                <div class="entry-media">
                                    <img src="<?= base_url() ?>/images/blog/img-1.jpg" alt>
                                </div>
                            ...
                            <div class="grid">
                                <div class="entry-media">
                                    <img src="<?= base_url() ?>/images/blog/img-2.jpg" alt>
                                </div>
                                <div class="entry-body">
                                    <div class="cats">Industry, Factory</div>
                            ...
                            <div class="grid">
                                <div class="entry-media">
                                    <img src="<?= base_url() ?>/images/blog/img-3.jpg" alt>
                                </div>
                                <div class="entry-body">
                                    <div class="cats">Industry, Factory</div>
